package com.jinsim.book.springboot.service;

import com.jinsim.book.springboot.domain.posts.Posts;
import com.jinsim.book.springboot.domain.posts.PostsRepository;
import com.jinsim.book.springboot.web.dto.PostsListResponseDto;
...
public class PostsService {
    ...
    public PostsResponseDto findById(Long id) {
        ...
        Posts entity = postsRepository.findById(id)
                .orElseThrow(() -> new
                        IllegalArgumentException("해당 게시글이 없습ㄴ디ㅏ. id=" + id));
